...
import { MapPin, Clock, CalendarPlus, Star, Loader2, AlertTriangle } from 'lucide-react'
      ...
      {!isLoading && error && (
        <div className="mx-auto max-w-2xl px-8 py-12">
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-6 text-center">
            ...
            <h3 className="mt-3 font-semibold text-foreground">Unable to load calendar</h3>
