        ...
        <section className="mx-auto max-w-6xl px-4 py-10 sm:px-8 sm:py-16">
          ...
          <div className="mt-8 grid gap-6 sm:mt-12 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-xl border border-muted/20 bg-surface p-5 shadow-sm transition-shadow hover:shadow-md sm:p-6">
              ...
              <h3 className="text-base font-semibold text-foreground sm:text-lg">Workshops</h3>
            ...
            <div className="rounded-xl border border-muted/20 bg-surface p-5 shadow-sm transition-shadow hover:shadow-md sm:p-6">
              ...
              <h3 className="text-base font-semibold text-foreground sm:text-lg">Hackathons</h3>
              <p className="mt-2 text-xs text-foreground/70 sm:text-sm">
            ...
            <div className="rounded-xl border border-muted/20 bg-surface p-5 shadow-sm transition-shadow hover:shadow-md sm:p-6">
              ...
              <h3 className="text-base font-semibold text-foreground sm:text-lg">Community</h3>
              <p className="mt-2 text-xs text-foreground/70 sm:text-sm">
            ...
            <div className="rounded-xl border border-muted/20 bg-surface p-5 shadow-sm transition-shadow hover:shadow-md sm:p-6">
              ...
              <h3 className="text-base font-semibold text-foreground sm:text-lg">Resources</h3>
              <p className="mt-2 text-xs text-foreground/70 sm:text-sm">
